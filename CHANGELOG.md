...
* Добавлена возможность явно указывать тип компонента вместо позиционного обозначения;

## 1.0.10
* Добавлена поддержка позиционных обозначений;
* Добавлена настройка столбцов при выгрузке отчета;

## 1.0.9
* Добавлена нумерация строк в списке;
* Добавлена подсветка строки с ошибкой;
* Добавлен возврат номера строки с ошибкой при обработке на бэкенде;
* Добавлены тесты;
* Исправлены ошибки парсинга;

## 1.0.8
* Добавлено предупреждение об изменении исходных данных;
